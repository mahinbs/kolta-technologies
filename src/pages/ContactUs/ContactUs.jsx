      ...
      <section className="py-14">
        <div className="wrapper flex flex-col-reverse md:grid grid-cols-2 gap-7">
          ...
          <div data-aos="fade-up" className="space-y-4">
            <h2 className="text1 text-primary">Get in touch</h2>
            <div className="h-2 w-[18rem] bg-white"></div>
            <h5 className="text2">
              Share goals, deadlines, and constraints—we’ll propose a path.
            </h5>
            <p className="desc">
              Reach the team behind koltatech.ai-caliber delivery: apps, web,
              data engineering, analytics, games, UI/UX, and cloud foundations.
            </p>
