      ...
      >
        <div className="relative space-y-4">
          ...
          >
            ...
            <p className="font-semibold uppercase">Core capabilities</p>
          </div>
          <h2 data-aos="fade-right" className="text1 z-[2] relative">
            Seven practices, <br />{" "}
            <span className="text-primary1">one specification-first </span>
            mindset
            <br />
          </h2>
          <p>
            App Development, Web Development+, Data Engineering, Data Science
            And Analytics, Game Development, UI/UX Design, and Cloud Solutions—each
            engagement starts from your requirements and measurable outcomes, not
            our favorite stack.
          </p>
