    ...
    >
      ...
      <div className="wrapper flex flex-col-reverse md:grid grid-cols-2 gap-7 relative z-[1]">
        ...
        <div className="space-y-4">
          ...
          <h5 className="text2">
            Tell us what you are shipping next—we’ll match the right squad.
          </h5>
          <p className="desc">
            Whether it is mobile, Web Development+, pipelines, or cloud landing
            zones, we respond with clarity on scope, timeline, and ownership.
          </p>
          <div className="space-y-4">
