  ...
  return (
    <div className="py-14 relative overflow-hidden">
      ...
      <div data-aos="fade-up" className="wrapper text-center space-y-3 mb-8">
        <h2 className="text1 text-primary2">What partners say</h2>
        <p className="desc max-w-4xl mx-auto">
          Product, data, and operations leaders who needed shipping discipline—not
          slideware. Their words reflect how we work across apps, Web
          Development+, data platforms, and cloud at koltatech.ai expectations.
        </p>
      </div>
      <Swiper
        data-aos="fade-up"
