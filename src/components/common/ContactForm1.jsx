  ...
  return (
    <div id="contact" className="relative pt-14 pb-4 overflow-hidden">
      ...
      <div className="wrapper space-y-3">
        ...
        <h2 className="text1 text-center">Request a project brief review</h2>
        <div>
          <p className="desc max-w-3xl text-center mx-auto">
            Tell us about apps, Web Development+, data, cloud, games, or design
            initiatives—we reply with next steps, not generic brochures.
          </p>
        </div>
